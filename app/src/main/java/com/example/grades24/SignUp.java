...
public class SignUp extends AppCompatActivity {
    ...
    public  void onClick(View view)
    {
        ...
        teacher=findViewById(R.id.radioButtonTeacher);
        String emailPattern = "[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+";
        email = findViewById(R.id.editTextTextEmailAddress2);
        pass = findViewById(R.id.editTextTextPassword3);
        pass2=findViewById(R.id.editTextTextPassword4);
        if (email.getText().toString().isEmpty() || pass.getText().toString().isEmpty()||pass2.getText().toString().isEmpty()||(!(teacher.isChecked())&&!(student.isChecked())))
        {
        ...
        {
//            if(pass != pass2){
//                Toast.makeText(getApplicationContext(), "Entered Passwords are not same! ", Toast.LENGTH_SHORT).show();
//            }
